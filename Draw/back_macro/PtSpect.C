...
void PtSpect(TString sType = "Kshort"){
  ...
  TString sPath = "/home/cuipengyao/study/pPb/Local/ThisAna/TestPCL/PCL";
  //if(IsIncl) sPath = "/home/cuipengyao/study/pPb/Local/ThisAna/Incl";
  if(IsIncl) sPath = "/home/cuipengyao/study/pPb/Local/ThisAna/TestPCL";
  ...
  TString sCent[] = {"5100", "510", "1100", "110"}; 
  TString sTex[] = {"5-100", "5-10", "1-100", "1-10"};
  ...
  for (Int_t i = 0; i< nHist; i++){
    ...
    if(IsIncl){
      TString sInclList = Form("%s_%s_Default_%s", sList.Data(), sType.Data(), sCent[i].Data());
      //sInclList = Form("%s_%s_%s", sList.Data(), sType.Data(), sCent[i].Data());
      ...
      TFile *f = TFile::Open("./result/PtSpect_ThisAna_TestPCL.root", "UPDATE");
      f->cd(); hIncl->Write(Form("hPtIncl_%s_%s",sType.Data(), sCent[i].Data()), TObject::kSingleKey); f->Close();
    }
    
    if(IsJC){
      TString sJCList = Form("%s_%s_Default_JC_%s", sList.Data(), sType.Data(), sCent[i].Data()); 
      ...
      TFile *f = TFile::Open("./result/PtSpect_ThisAna_TestPCL.root", "UPDATE");
      f->cd(); hJC->Write(Form("hPtJC_%s_%s",sType.Data(), sCent[i].Data()), TObject::kSingleKey); f->Close();
    } 
    
    if(IsPC){
      TString sPCLList = Form("%s_%s_Default_PCL_%s", sList.Data(), sType.Data(), sCent[i].Data()); 
      ...
      TString sPCUList = Form("%s_%s_Default_PCL_%s", sList.Data(), sType.Data(), sCent[i].Data()); 
      ...
      TFile *f = TFile::Open("./result/PtSpect_ThisAna_TestPCL.root", "UPDATE");
      f->cd(); hPC->Write(Form("hPtPC_%s_%s", sType.Data(), sCent[i].Data()), TObject::kSingleKey); f->Close();
    }
    
    if(IsOC){
      TString sOCList = Form("%s_%s_Default_OC_%s", sList.Data(), sType.Data(), sCent[i].Data()); 
      ...
      TFile *f = TFile::Open("./result/PtSpect_ThisAna_TestPCL.root", "UPDATE");
      f->cd(); hOC->Write(Form("hPtOC_%s_%s", sType.Data(), sCent[i].Data()), TObject::kSingleKey); f->Close();
    } 
    ...
    if(IsJC && IsPC){
      ...
      TFile *f = TFile::Open("./result/PtSpect_ThisAna_TestPCL.root", "UPDATE");
      f->cd(); hJE->Write(Form("hPtJE_%s_%s", sType.Data(), sCent[i].Data()), TObject::kSingleKey); f->Close();
    } 
    
    if(IsNJ){
      TString sNJList = Form("%s_%s_Default_NJ_%s", sList.Data(), sType.Data(), sCent[i].Data()); 
      ...
      TFile *f = TFile::Open("./result/PtSpect_ThisAna_TestPCL.root", "UPDATE");
      f->cd(); hNJ->Write(Form("hPtNJ_%s_%s", sType.Data(), sCent[i].Data()), TObject::kSingleKey); f->Close();
    } 

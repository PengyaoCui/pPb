...
//=============================================================================
  ...
  auto f = TFile::Open("/home/cuipengyao/study/pPb/Local/ThisAna/JEBins/AnalysisOutputs_Results.root", "read");
  auto l04 = (TList*)f->Get(Form("listResults_Lambda_Default_OC_0100"));
  auto lPCL = (TList*)f->Get(Form("listResults_Lambda_Default_PCL_0100"));
  auto lPCU = (TList*)f->Get(Form("listResults_Lambda_Default_PCU_0100"));
  f->Close();
  ...
  auto l06 = (TList*)f->Get(Form("listResults_Lambda_Default_OC_0100"));
  f->Close();
  f = TFile::Open("/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE/UE/OC08/AnalysisOutputs_Results.root", "read");
  auto l08 = (TList*)f->Get(Form("listResults_Lambda_Default_OC_0100"));
  f->Close();
...
//=============================================================================
  ...
  can->SaveAs(Form("./figure/UEUncer/Lambda_pPb5d02TeV_DiffOC_0100_Bin1.eps"));
  can->SaveAs(Form("./figure/UEUncer/Lambda_pPb5d02TeV_DiffOC_0100_Bin1.pdf"));
  can->SaveAs(Form("./figure/UEUncer/Lambda_pPb5d02TeV_DiffOC_0100_Bin1.png"));
  CanvasEnd(can);
  return;
}

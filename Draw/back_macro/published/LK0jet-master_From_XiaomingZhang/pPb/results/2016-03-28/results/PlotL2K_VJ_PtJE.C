void PlotL2K_VJ_PtJE(const UInt_t kAct = 3,
                     const UInt_t kPtv = 0,  // 0: 2.2 < pTV0 < 3.7; 1: 0.6 < pTV0 < 1.8; 2: 4.2 < pTV0 < 12
                     const UInt_t kOut = 0)
{
...
//=============================================================================
  ...
  DrawGraph(gL2Ksyst20, wcl[7], "E2"); DrawGraph(gL2Kstat20, wcl[7], wmk[0], "P");
  ...
  tex->DrawLatex(0.16, 0.90, Form("p-Pb #sqrt{s_{NN}}=5.02 TeV"));

void PlotL2K_Pt_Comp(const UInt_t kCje = 0, // 0: JC = 0.2; 2: JC = 0.4
                     const UInt_t kAct = 7,
...
//=============================================================================
  ...
  DrawGraph(gSyst04, wcl[7], "E2"); DrawGraph(gStat04, wcl[7], wmk[0], "P");
  DrawGraph(gSyst03, wcl[1], "E2"); DrawHisto(hStat03, wcl[1], wmk[0], "SAME");

  leg = new TLegend(0.70, 0.62, 0.96, 0.90); SetupLegend(leg);
  ...
  tex->DrawLatex(0.16, 0.92, Form("ALICE p-Pb #sqrt{s_{NN}}=5.02 TeV"));
  tex->DrawLatex(0.16, 0.84, Form("%s, anti-#it{k}_{T}", sPtjL[kPtj].Data()));
  tex->DrawLatex(0.16, 0.76, Form("|#eta_{jet}|<0.35, |#eta_{V^{0}}|<0.75, %s", sCjeL[kCje].Data()));
  CanvasEnd(can);
//=============================================================================

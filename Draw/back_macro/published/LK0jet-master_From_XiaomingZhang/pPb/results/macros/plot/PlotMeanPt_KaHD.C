...
void PlotMeanPt_KaHD(const UInt_t kOut=0)
{
...
//=============================================================================
  ...
  TGraphAsymmErrors *gStat21 = GetStat(kJC02, kPtj10, kBin21, kKshort, 1, "JC"); gStat21->SetName("gStat21");
  TGraphAsymmErrors *gSyst21 = GetSyst(kJC02, kPtj10, kBin21, kKshort, 1, "JC"); gSyst21->SetName("gSyst21");

  TGraphAsymmErrors *gStat41 = GetStat(kJC04, kPtj10, kBin21, kKshort, 1, "JC"); gStat41->SetName("gStat41");
  TGraphAsymmErrors *gSyst41 = GetSyst(kJC04, kPtj10, kBin21, kKshort, 1, "JC"); gSyst41->SetName("gSyst41");


  TGraphAsymmErrors *gStat22 = GetStat(kJC02, kPtj20, kBin21, kKshort, 1, "JC"); gStat22->SetName("gStat22");
  TGraphAsymmErrors *gSyst22 = GetSyst(kJC02, kPtj20, kBin21, kKshort, 1, "JC"); gSyst22->SetName("gSyst22");

  TGraphAsymmErrors *gStat42 = GetStat(kJC04, kPtj20, kBin21, kKshort, 1, "JC"); gStat42->SetName("gStat42");
  TGraphAsymmErrors *gSyst42 = GetSyst(kJC04, kPtj20, kBin21, kKshort, 1, "JC"); gSyst42->SetName("gSyst42");
//=============================================================================
...
//=============================================================================
  ...
  const TString sCanN = Form("MeanPt_KaHD");
...
/*leg = new TLegend(0.54, 0.52, 0.76, 0.66); SetupLegend(leg);
  ...
  tex->DrawLatex(0.16, 0.90, Form("K_{S}^{0}, p-Pb #sqrt{s_{NN}}=5.02 TeV, anti-#it{k}_{T}, |#eta_{jet}|<0.35, |#eta_{V^{0}}|<0.75"));
  CanvasEnd(can);
//=============================================================================

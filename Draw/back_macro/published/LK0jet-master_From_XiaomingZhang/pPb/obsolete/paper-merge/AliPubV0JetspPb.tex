...
\input{LaTeX/AliPubUserDef}

\linenumbers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{body/aDefinitions}
...
proton-lead \sep collision \sep  LHC \sep jet \sep strangeness
\end{keyword}
\end{frontmatter}
%\maketitle
\newpage
...
%==========================MAIN============================%
%==========================================================%
\input{body/c01Introduction.tex}
\input{body/c02DataAnalysis.tex}
\input{body/c03Results.tex}
\input{body/c04Conclusions.tex}
%==========================================================%
%======================ACK+BIBLIO==========================%
%==========================================================%
\ifpreprint
...
\input{acknowledgements.tex}        %%%%%%% get the latest version before submitting
\end{acknowledgement}
\ifbibtex

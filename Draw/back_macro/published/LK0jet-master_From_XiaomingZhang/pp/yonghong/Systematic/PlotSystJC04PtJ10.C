void PlotSystJC04PtJ10(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  TH1D *hRatioVErrHD = (TH1D*)list->FindObject("hRatioVErrHD_list_JR04_JC04_ZNA_000_100_PtJ10_GetRatioVStatHD");
  TH1D *hRatioVErrJE = (TH1D*)list->FindObject("hRatioVErrJE_HD_list_JR04_JC04_ZNA_000_100_PtJ10_GetRatioVStatHD");
  TH1D *hRatioVErrJC = (TH1D*)list->FindObject("hRatioVErrJC_HD_list_JR04_JC04_ZNA_000_100_PtJ10_GetRatioVStatHD");
  TH1D *hRatioVErrUE = (TH1D*)list->FindObject("hRatioVErrUE_HD_list_JR04_JC04_ZNA_000_100_PtJ10_GetRatioVStatHD");
//=============================================================================
...
//=============================================================================
  ...
  can = MakeCanvas("Syst_JC04_PtJ10");

...
void PlotMeanPt_PtVJ(const UInt_t kAct = 1,
                     const UInt_t kVar = 1,
                     const UInt_t kOut = 0)
{
...
//=============================================================================
  ...
  TGraphAsymmErrors *gStat10 = GetStat(kAct, kPtj10, kBin21, kVar, 1, "VJ"); gStat10->SetName("gStat10");
  TGraphAsymmErrors *gSyst10 = GetSyst(kAct, kPtj10, kBin21, kVar, 1, "VJ"); gSyst10->SetName("gSyst10");

  TGraphAsymmErrors *gStat20 = GetStat(kAct, kPtj20, kBin21, kVar, 1, "VJ"); gStat20->SetName("gStat20");
  TGraphAsymmErrors *gSyst20 = GetSyst(kAct, kPtj20, kBin21, kVar, 1, "VJ"); gSyst20->SetName("gSyst20");
//=============================================================================
...
//=============================================================================
  ...
  const TString sCanN = Form("MeanPt_PtVJ_%s_%s", sActN[kAct].Data(), sVarN[kVar].Data());
  ...
  DrawGraph(gStat10, wcl[1], wmk[1], "P"); DrawGraph(gSyst10, wcl[1], "E2");
  DrawGraph(gStat20, wcl[3], wmk[1], "P"); DrawGraph(gSyst20, wcl[3], "E2");

  leg = new TLegend(0.68, 0.66, 0.96, 0.80); SetupLegend(leg);
  leg->AddEntry(gStat10, "#it{p}_{T,jet}>10 GeV/#it{c}", "LP")->SetTextSizePixels(24);
  leg->AddEntry(gStat20, "#it{p}_{T,jet}>20 GeV/#it{c}", "LP")->SetTextSizePixels(24);
  leg->Draw();
...
/*leg = new TLegend(0.54, 0.52, 0.76, 0.66); SetupLegend(leg);
  ...
  tex->DrawLatex(0.16, 0.90, Form("%s, p-Pb #sqrt{s_{NN}}=5.02 TeV, %s", sVarL[kVar].Data(), sActL[kAct].Data()));

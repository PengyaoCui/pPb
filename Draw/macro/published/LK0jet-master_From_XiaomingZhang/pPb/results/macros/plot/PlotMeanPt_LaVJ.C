...
void PlotMeanPt_LaVJ(const UInt_t kPtj = 1,
                     const UInt_t kOut = 0)
{
...
//=============================================================================
  ...
  TGraphAsymmErrors *gStat0 = GetStat(0, kPtj, kBin21, kLambda, 1, "VJ"); gStat0->SetName("gStat0");
  TGraphAsymmErrors *gSyst0 = GetSyst(0, kPtj, kBin21, kLambda, 1, "VJ"); gSyst0->SetName("gSyst0");

  TGraphAsymmErrors *gStat1 = GetStat(1, kPtj, kBin07, kLambda, 1, "VJ"); gStat1->SetName("gStat1");
  TGraphAsymmErrors *gSyst1 = GetSyst(1, kPtj, kBin07, kLambda, 1, "VJ"); gSyst1->SetName("gSyst1");

  TGraphAsymmErrors *gStat2 = GetStat(2, kPtj, kBin07, kLambda, 1, "VJ"); gStat2->SetName("gStat2");
  TGraphAsymmErrors *gSyst2 = GetSyst(2, kPtj, kBin07, kLambda, 1, "VJ"); gSyst2->SetName("gSyst2");
//=============================================================================
...
//=============================================================================
  ...
  const TString sCanN = Form("MeanPt_LaVJ_%s", sPtjN[kPtj].Data());
...
/*leg = new TLegend(0.54, 0.52, 0.76, 0.66); SetupLegend(leg);
  ...
  tex->DrawLatex(0.16, 0.90, Form("#Lambda+#bar{#Lambda}, p-Pb #sqrt{s_{NN}}=5.02 TeV")) ;

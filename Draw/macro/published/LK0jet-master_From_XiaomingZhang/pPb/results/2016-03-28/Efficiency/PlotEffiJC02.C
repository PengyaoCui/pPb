void PlotEffiJC02(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  TList *list = (TList*)file->Get("listHist_JE_JR02_JC02_V0A_000_010");
  file->Close();
...
//=============================================================================
  ...
  TPad *pUpper = 0;
  TPad *pLower = 0;
  can = MakeCanvas("EffiJC02_Kshort");
  ...
  leg->AddEntry(hKshortJC, "#it{R}(V^{0},jet)<0.2", "LP")->SetTextSizePixels(24);
  ...
  tex->DrawLatex(0.14, 0.84, "Jet: anti-#it{k}_{T}, #it{R}=0.2, #it{p}_{T,jet}^{ch}>10 GeV/#it{c}, |#eta_{jet}|<0.35");
...
//=============================================================================
  ...
  can = MakeCanvas("EffiJC02_Lambda");
  pUpper = MakePadUpper(can->GetName());
  frm = pUpper->DrawFrame(dflx, 0.12, dfux, 0.58);
  SetupFrame(frm, 0., 0.05, 0., 0.07, 0., 0.7, "", "Efficiency");
  ...
  leg->AddEntry(hLambdaJC, "#it{R}(V^{0},jet)<0.2", "LP")->SetTextSizePixels(24);
...
//=============================================================================
  ...
  can = MakeCanvas("EffiJC02_AntiLa");
  pUpper = MakePadUpper(can->GetName());
  frm = pUpper->DrawFrame(dflx, 0.12, dfux, 0.58);
  SetupFrame(frm, 0., 0.05, 0., 0.07, 0., 0.7, "", "Efficiency");
  ...
  leg->AddEntry(hAntiLaJC, "#it{R}(V^{0},jet)<0.2", "LP")->SetTextSizePixels(24);

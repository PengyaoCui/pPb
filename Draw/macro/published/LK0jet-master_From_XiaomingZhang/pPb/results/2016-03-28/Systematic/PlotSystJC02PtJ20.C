void PlotSystJC02PtJ20(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  TList *list = (TList*)file->Get("list_JC02_JR02_PtJ20");
  file->Close();

  TH1D *hRatioVErrHD = (TH1D*)list->FindObject("hRatioVErrHD_list_JR02_JC02_ZNA_000_100_PtJ20_GetRatioVStatHD");
  TH1D *hRatioVErrJE = (TH1D*)list->FindObject("hRatioVErrJE_HD_list_JR02_JC02_ZNA_000_100_PtJ20_GetRatioVStatHD");
  TH1D *hRatioVErrJC = (TH1D*)list->FindObject("hRatioVErrJC_HD_list_JR02_JC02_ZNA_000_100_PtJ20_GetRatioVStatHD");
  TH1D *hRatioVErrUE = (TH1D*)list->FindObject("hRatioVErrUE_HD_list_JR02_JC02_ZNA_000_100_PtJ20_GetRatioVStatHD");
//=============================================================================
...
//=============================================================================
  ...
  can = MakeCanvas("Syst_JC02_PtJ20");
  ...
  tex->DrawLatex(0.16, 0.76, "#it{p}_{T,jet}^{ch}>20 GeV/#it{c}, #it{R}=0.2, #it{R}(V^{0},jet)<0.2");

void PlotL2K_Pt_PtJE(const UInt_t kCje = 2,  // 0: JC = 0.2; 2: JC = 0.4
                     const UInt_t kAct = 7,
                     const UInt_t kOut = 0)
{
...
//=============================================================================
  ...
  TString sList = Form("list_%s_%s", sCjeN[kCje].Data(),
                                           sActN[kAct].Data());


  sList="list_JC04_JR04_PtJ10";
...
//=============================================================================
  ...
  TH1D *hSystMB = (TH1D*)list->FindObject("hRatioV_Inclu_Syst");
...
//  TH1D *hSyst20 = (TH1D*)list->FindObject("hRatioV_Ptj20_Syst");
  ...
  TGraphErrors *gStatMB = ConvHistogramToGraphErrors(hStatMB, 0x0, hStatMB->GetNbinsX());
  TGraphErrors *gSystMB = ConvHistogramToGraphErrors(hStatMB, hSystMB, hStatMB->GetNbinsX());
...
//  DrawGraph(gSyst20, wcl[6], "E2"); DrawGraph(gStat20, wcl[6], wmk[0], "P");
  DrawGraph(gSyst10, wcl[1], "E2"); DrawHisto(hStat10, wcl[1], wmk[0], "SAME");
  ...
  leg->AddEntry(hStat10, "#it{p}_{T}^{jet,ch} > 8 GeV/#it{c}", "LP")->SetTextSizePixels(24);
...
//  tex->DrawLatex(0.16, 0.92, Form("p-Pb #sqrt{s_{NN}}=5.02 TeV"));
  ...
  tex->DrawLatex(0.16, 0.84, Form("anti-#it{k}_{T}, %s", sCjeL[kCje].Data()));

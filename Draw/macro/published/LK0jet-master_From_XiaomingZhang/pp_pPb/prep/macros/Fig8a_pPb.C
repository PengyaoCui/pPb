void Fig8a_pPb(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  TList *listUE = (TList*)file->Get("listUE_JC04_Mean_PtJ10");
  TList *list10 = (TList*)file->Get("listHD_JC02_Mean_PtJ10");
  TList *list20 = (TList*)file->Get("listHD_JC02_Mean_PtJ20");
  file->Close();
//=============================================================================
...
//=============================================================================
  ...
  file = TFile::Open("data/pythia/AnalysisOutputs_5020GeV.root");
...
//=============================================================================
  ...
  DrawGraph(gPyHard, wcl[3], "C");

  leg = new TLegend(0.66, 0.54, 0.96, 0.86); SetupLegend(leg);
  ...
  tex->DrawLatex(0.16, 0.92, "p-Pb #sqrt{#it{s}_{NN}}=5.02 TeV");
  tex->DrawLatex(0.16, 0.84, "Jet: anti-#it{k}_{T}, |#eta_{jet}|<0.35");
  tex->DrawLatex(0.16, 0.76, "|#eta_{V^{0}}|<0.75, #it{R}(V^{0},jet)<0.2");
  tex->DrawLatex(0.26, 0.18, "Mean #it{R}=0.2, 0.3 and 0.4");
  CanvasEnd(can);
//=============================================================================

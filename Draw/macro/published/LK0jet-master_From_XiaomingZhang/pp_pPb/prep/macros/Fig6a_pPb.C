void Fig6a_pPb(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  TList *listUE = (TList*)file->Get("listUE_JC04_JR04_PtJ10");
  TList *listJE = (TList*)file->Get("listJE_JC04_JR04_PtJ10");
  TList *listHD = (TList*)file->Get("listHD_JC04_JR04_PtJ10");
  file->Close();
//=============================================================================
...
//=============================================================================
  ...
  NormBinningHistogram(hKshortStatIn);
  ...
  NormBinningHistogram(hKshortStatUE);
  ...
  NormBinningHistogram(hKshortStatJE);
  ...
  NormBinningHistogram(hKshortStatHD);
...
//=============================================================================
  ...
  can = MakeCanvas("Fig6a_pPb"); can->SetLogy();

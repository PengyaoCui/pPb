void Fig6b_pPb(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  NormBinningHistogram(hLtotalStatIn);
  ...
  NormBinningHistogram(hLtotalStatUE);
  ...
  NormBinningHistogram(hLtotalStatJE);
  ...
  NormBinningHistogram(hLtotalStatHD);
...
//=============================================================================
  ...
  can = MakeCanvas("Fig6b_pPb"); can->SetLogy();

void Fig4b_pPb(const Bool_t bPrint=kFALSE)
{
...
//=============================================================================
  ...
  TList *list = (TList*)file->Get("listHD_JC04_JR04_PtJ20");
  file->Close();
...
//=============================================================================
  ...
  list = (TList*)file->Get("list_SystJE_RatioV_PtJ20");
  file->Close();
...
//=============================================================================
  ...
  list = (TList*)file->Get("list_SystUE_RatioV_PtJ20");
  file->Close();

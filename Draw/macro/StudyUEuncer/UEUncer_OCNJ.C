...
void UEUncer_OCNJ(const TString sType = "Xi", const TString CentMin = "0", const TString CentMax = "100"){
  ...
  TList *l = new TList();
  l->Add(hUMax);
  l->Write(Form("%s_UESub_%s%s_OCNJ",sType.Data(), CentMin.Data(), CentMax.Data()), TObject::kSingleKey);
  f->Close();

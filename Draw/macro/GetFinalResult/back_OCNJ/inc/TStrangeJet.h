...
//-------------------------------------------------------------
TH1D *GetPCRatioLK(TString sCent = "0100", TString sPath = "/home/cuipengyao/study/pPb/Local/ThisAna/JE")
{
  auto hK(GetPCPtSpect("Kshort", sCent, sPath));
  auto hL(GetPCPtSpect("Lambda", sCent, sPath));
  auto hA(GetPCPtSpect("AntiLa", sCent, sPath));
//=============================================================================
  hL->Add(hA);
...
//-------------------------------------------------------------
TH1D *GetPCRatioXK(TString sCent = "0100", TString sPath = "/home/cuipengyao/study/pPb/Local/ThisAna/JE")
{
  auto hK(GetPCPtSpect("Kshort", sCent, sPath));
  auto hX(GetPCPtSpect("Xi", sCent, sPath));
//=============================================================================
...
//-------------------------------------------------------------
TH1D *GetPCRatioXL(TString sCent = "0100", TString sPath = "/home/cuipengyao/study/pPb/Local/ThisAna/JE")
{
  auto hL(GetPCPtSpect("Lambda", sCent, sPath));
  auto hA(GetPCPtSpect("AntiLa", sCent, sPath));
  auto hX(GetPCPtSpect("Xi", sCent, sPath));

...
void UEUncer(const TString sType = "Xi", const TString CentMin = "0", const TString CentMax = "100"){
  ...
  hUE[0] = (TH1D*)listPC04->FindObject(Form("h%s_%s%s", sType.Data(), CentMin.Data(), CentMax.Data()));
  hUE[1] = (TH1D*)listPC02->FindObject(Form("h%s_%s%s", sType.Data(), CentMin.Data(), CentMax.Data()));
  hUE[2] = (TH1D*)listPC06->FindObject(Form("h%s_%s%s", sType.Data(), CentMin.Data(), CentMax.Data()));

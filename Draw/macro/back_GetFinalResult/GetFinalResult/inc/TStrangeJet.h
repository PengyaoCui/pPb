...
//-------------------------------------------------------------
TH1D* GetOC08PtSpect(TString sType = "Kshort", TString sCent = "0100", TString Path = "/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE/UE/OC08"){

  TString sPath = Path.Data();
...
//-------------------------------------------------------------
TH1D *GetOC08RatioLK(TString sCent = "0100")
{
  auto hK(GetOC08PtSpect("Kshort", sCent));
  auto hL(GetOC08PtSpect("Lambda", sCent));
  auto hA(GetOC08PtSpect("AntiLa", sCent));
//=============================================================================
  hL->Add(hA);
...
//-------------------------------------------------------------
TH1D *GetOC08RatioXK(TString sCent = "0100")
{
  auto hK(GetOC08PtSpect("Kshort", sCent));
  auto hX(GetOC08PtSpect("Xi", sCent));
//=============================================================================
...
//-------------------------------------------------------------
TH1D *GetOC08RatioOK(TString sCent = "0100", TString Path = "/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE_Omega/UE/OC08")
{
  auto hK(GetOC08PtSpect("Kshort", sCent, Path));
  auto hO(GetOC08PtSpect("Omega", sCent, Path));
//=============================================================================
...
//-------------------------------------------------------------
TH1D *GetOC08RatioXL(TString sCent = "0100")
{
  auto hL(GetOC08PtSpect("Lambda", sCent));
  auto hA(GetOC08PtSpect("AntiLa", sCent));
  auto hX(GetOC08PtSpect("Xi", sCent));
...
//-------------------------------------------------------------
TH1D *GetOC08RatioOL(TString sCent = "0100", TString Path = "/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE_Omega/UE/OC08")
{
  auto hL(GetOC08PtSpect("Lambda", sCent, Path));
  auto hA(GetOC08PtSpect("AntiLa", sCent, Path));
  auto hO(GetOC08PtSpect("Omega", sCent, Path));
//=============================================================================
  hL->Add(hA);
...
//-------------------------------------------------------------
TH1D *GetOC08RatioOX(TString sCent = "0100", TString Path = "/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE_Omega/UE/OC08")
{
  auto hX(GetOC08PtSpect("Xi", sCent, Path));
  auto hO(GetOC08PtSpect("Omega", sCent, Path));
//=============================================================================

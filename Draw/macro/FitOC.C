...
//=============================================================================
  ...
  auto l04 = (TList*)f->Get(Form("listResults_Kshort_Default_OC_010"));
  auto lPCL = (TList*)f->Get(Form("listResults_Kshort_Default_PCL_010"));
  auto lPCU = (TList*)f->Get(Form("listResults_Kshort_Default_PCU_010"));
  f->Close();
  ...
  auto l06 = (TList*)f->Get(Form("listResults_Kshort_Default_OC_010"));
  f->Close();
  f = TFile::Open("/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE/UE/OC08/AnalysisOutputs_Results.root", "read");
  auto l08 = (TList*)f->Get(Form("listResults_Kshort_Default_OC_010"));
  f->Close();
  ...
  h0->SetBinContent(h0->FindBin(TMath::Pi()*0.5), Fun->Integral(1.5, 1.6)/0.1); h0->SetBinError(h0->FindBin(TMath::Pi()*0.5), h08->GetBinError(1));

//=============================================================================
  auto dflx(0.), dfux(2.);
  auto dfly(0.0), dfuy(0.4);
  ...
  tex->DrawLatex(0.16, 0.82, "Kshort");
  tex->DrawLatex(0.16, 0.72, "0.6< #it{p}_{T} < 1.6");
  
  can->SaveAs(Form("./figure/UEUncer/Kshort_pPb5d02TeV_DiffOC_010_Bin1.eps"));
  can->SaveAs(Form("./figure/UEUncer/Kshort_pPb5d02TeV_DiffOC_010_Bin1.pdf"));
  can->SaveAs(Form("./figure/UEUncer/Kshort_pPb5d02TeV_DiffOC_010_Bin1.png"));
  CanvasEnd(can);
  return;
}

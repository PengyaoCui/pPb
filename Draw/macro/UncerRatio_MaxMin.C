...
void UncerRatio_MaxMin(const TString sType = "Xi", const TString CentMin = "0", const TString CentMax = "100"){
  ...
  leg1->Draw();
  gStyle->SetOptStat("");
  can1->SaveAs(Form("./figure/CheckUEsubUncer/%s_toK_Uncert_%s%s_Max-Min.eps", sType.Data(), CentMin.Data(), CentMax.Data()));
  can1->SaveAs(Form("./figure/CheckUEsubUncer/%s_toK_Uncert_%s%s_Max-Min.pdf", sType.Data(), CentMin.Data(), CentMax.Data()));
  can1->SaveAs(Form("./figure/CheckUEsubUncer/%s_toK_Uncert_%s%s_Max-Min.png", sType.Data(), CentMin.Data(), CentMax.Data()));
  //DrawAliLogo(0.65, 0.90, 24, kTRUE);
  CanvasEnd(can1);
  return;
}

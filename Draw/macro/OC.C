...
//=============================================================================
  ...
  auto l04 = (TList*)f->Get(Form("listResults_Kshort_Default_OC_0100"));
  auto lPCL = (TList*)f->Get(Form("listResults_Kshort_Default_PCL_0100"));
  auto lPCU = (TList*)f->Get(Form("listResults_Kshort_Default_PCU_0100"));
  f->Close();
  ...
  auto l06 = (TList*)f->Get(Form("listResults_Kshort_Default_OC_0100"));
  f->Close();
  f = TFile::Open("/home/cuipengyao/study/pPb/Local/ThisAna/Uncertainty/JE/UE/OC08/AnalysisOutputs_Results.root", "read");
  auto l08 = (TList*)f->Get(Form("listResults_Kshort_Default_OC_0100"));
  f->Close();
...
//=============================================================================
  ...
  tex->DrawLatex(0.16, 0.82, "K^{0}_{S}");
  tex->DrawLatex(0.16, 0.72, "0.6< #it{p}_{T} < 1.6");
  
  can->SaveAs(Form("./figure/UEUncer/Kshort_pPb5d02TeV_DiffOC_0100_Bin1.eps"));
  can->SaveAs(Form("./figure/UEUncer/Kshort_pPb5d02TeV_DiffOC_0100_Bin1.pdf"));
  can->SaveAs(Form("./figure/UEUncer/Kshort_pPb5d02TeV_DiffOC_0100_Bin1.png"));
  CanvasEnd(can);
  return;
}

...
const char* uniqueName = "LHC16q_";//

const auto isMC(kFALSE);   // trigger, if MC handler should be used
//const char* pattern = "/AOD202/*AOD.root";  //MC
//const char* gridDir = "/alice/sim/2017/LHC17f2b_cent/";  //MC
//const char* pattern = "/AOD202/*AOD.root";  //MC
//const char* gridDir = "/alice/sim/2017/LHC17f2a_cent_fix/";  //MC
const char* pattern = "/pass1_CENT_wSDD/AOD190/*AOD.root"; //RD
const char* gridDir = "/alice/data/2016/LHC16q"; //RD

const char* runNumbers = //"265336";
                     "265525, 265521, 265501, 265500, 265499, 265435, 265427, 265426, 265425, 265424, 265422, 265421, 265420, 265419, 265388, 265387";
		     //"265385, 265384, 265383, 265381, 265378, 265377, 265344, 265343, 265342, 265339, 265338, 265336, 265335, 265334, 265332, 265309";
...
const TString sCentEsti = "ZNA";  // "V0M"; "V0A"; "V0C"
...
const TString sUsedRhoRD = "Rho";  // "RhoRD"
const TString sUsedRhoMC = "RhoMC";// "RhoMC"
//=============================================================================
...
{
  const TString sPeriodIn = isMC ? "LHC17f2b_cent_wSDD" : "LHC16q";
...
//=============================================================================
  ...
  if (bIsCentSel) {
    ...
    if (!isMC){
      ...
      taskCentSel->SetAlternateOADBforEstimators("LHC16q");//(Form("myOwnOADBfor%d",sPeriodIn.Data()));
    }
  }
...
//=============================================================================
  ...
  if (bAnaJetRD) {
    ...
    if (!sUsedRhoRD.IsNull()) {
      ...
      taskDeltaPt->SetForceBeamType(AliAnalysisTaskEmcal::kpA);
...
//=============================================================================
  ...
  taskStrangeMaker->SetCollitionType(AliPicoBaseDev::kPA);
  ...
  taskStrangeMaker->SetUseAnaUtils(kFALSE);
//=============================================================================
...
//=============================================================================
  ...
  while ((taskSE = dynamic_cast<AliAnalysisTaskSE*>(next()))) {
    ...
    if (taskSE->InheritsFrom("AliAnalysisTaskEmcal")) {
      ...
      taskEmcal->SetForceBeamType(AliAnalysisTaskEmcal::kpA);

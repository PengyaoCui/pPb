...
//=============================================================================
  TList *list = (TList*)file->Get(Form("%s_0100",fListLoop1st.Data())); if (list) { file->Close(); return;} else { list = new TList(); }
  TH2D *hPtInvM = 0;
  if (sOpt=="Kshort") {
...
//=============================================================================
  TList *list0 = (TList*)file->Get(Form("%s_090",fListLoop1st.Data())); if (list0) { file->Close(); return; } else { list0 = new TList(); }
  TH2D *hPtInvM0 = 0;
  hPtInvM0 = (TH2D*)hPtInvM->Clone(); list0->Add(hPtInvM0);
  TH1D *hEvent0 = (TH1D*)hEvent->Clone(); list0->Add(hEvent0);
  TH1D *hStrEvent0 = (TH1D*)hStrEvent->Clone(); list0->Add(hStrEvent0);
  
//=============================================================================
  TList *list1 = (TList*)file->Get(Form("%s_05",fListLoop1st.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
  TH2D *hPtInvM1 = 0;
  hPtInvM1 = (TH2D*)hPtInvM->Clone(); list1->Add(hPtInvM1);
  TH1D *hEvent1 = (TH1D*)hEvent->Clone(); list1->Add(hEvent1);
  TH1D *hStrEvent1 = (TH1D*)hStrEvent->Clone(); list1->Add(hStrEvent1);
  
//=============================================================================
  TList *list2 = (TList*)file->Get(Form("%s_510",fListLoop1st.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
  TH2D *hPtInvM2 = 0;
  hPtInvM2 = (TH2D*)hPtInvM->Clone(); list2->Add(hPtInvM2);
  TH1D *hEvent2 = (TH1D*)hEvent->Clone(); list2->Add(hEvent2);
  TH1D *hStrEvent2 = (TH1D*)hStrEvent->Clone(); list2->Add(hStrEvent2);
  
//=============================================================================
  TList *list3 = (TList*)file->Get(Form("%s_1020",fListLoop1st.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
  TH2D *hPtInvM3 = 0;
  hPtInvM3 = (TH2D*)hPtInvM->Clone(); list3->Add(hPtInvM3);
  TH1D *hEvent3 = (TH1D*)hEvent->Clone(); list3->Add(hEvent3);
  TH1D *hStrEvent3 = (TH1D*)hStrEvent->Clone(); list3->Add(hStrEvent3);

  //=============================================================================
  TList *list4 = (TList*)file->Get(Form("%s_2040",fListLoop1st.Data())); if (list4) { file->Close(); return; } else { list4 = new TList(); }
  TH2D *hPtInvM4 = 0;
  hPtInvM4 = (TH2D*)hPtInvM->Clone(); list4->Add(hPtInvM4);
  TH1D *hEvent4 = (TH1D*)hEvent->Clone(); list4->Add(hEvent4);
  TH1D *hStrEvent4 = (TH1D*)hStrEvent->Clone(); list4->Add(hStrEvent4);
  
  //=============================================================================
  TList *list5 = (TList*)file->Get(Form("%s_4060",fListLoop1st.Data())); if (list5) { file->Close(); return; } else { list5 = new TList(); }
  TH2D *hPtInvM5 = 0;
  hPtInvM5 = (TH2D*)hPtInvM->Clone(); list5->Add(hPtInvM5);
  TH1D *hEvent5 = (TH1D*)hEvent->Clone(); list5->Add(hEvent5);
  TH1D *hStrEvent5 = (TH1D*)hStrEvent->Clone(); list5->Add(hStrEvent5);
 
  //=============================================================================
  TList *list6 = (TList*)file->Get(Form("%s_6080",fListLoop1st.Data())); if (list6) { file->Close(); return; } else { list6 = new TList(); }
  TH2D *hPtInvM6 = 0;
  hPtInvM6 = (TH2D*)hPtInvM->Clone(); list6->Add(hPtInvM6);
  TH1D *hEvent6 = (TH1D*)hEvent->Clone(); list6->Add(hEvent6);
  TH1D *hStrEvent6 = (TH1D*)hStrEvent->Clone(); list6->Add(hStrEvent6);
  
  //=============================================================================
  TList *list7 = (TList*)file->Get(Form("%s_80100",fListLoop1st.Data())); if (list7) { file->Close(); return; } else { list7 = new TList(); }
  TH2D *hPtInvM7 = 0;
  hPtInvM7 = (TH2D*)hPtInvM->Clone(); list7->Add(hPtInvM7);
  TH1D *hEvent7 = (TH1D*)hEvent->Clone(); list7->Add(hEvent7);
  TH1D *hStrEvent7 = (TH1D*)hStrEvent->Clone(); list7->Add(hStrEvent7);
  ...
  while (fChainRD->GetEntry(iEvent++)) if (InitEvent("P")) {
   ...
   if(iEvent%1000000==0) cout<<iEvent/1000000<< " = M"<<endl; 
    Float_t dCent = -1.;
      ...
      if(dCent >= 0. && dCent< 100.){ hEvent->Fill(dCent);}//All Event Number
      if(dCent >=0. && dCent< 90.) {hEvent0->Fill(dCent);}//All Event Number
      if(dCent >=0. && dCent< 5.) {hEvent1->Fill(dCent);}//All Event Number
      if(dCent >=5. && dCent< 10.) {hEvent2->Fill(dCent);}//All Event Number
      if(dCent >=10. && dCent < 20.) {hEvent3->Fill(dCent);}//All Event Number
      if(dCent >=20. && dCent < 40.) {hEvent4->Fill(dCent);}//All Event Number
      if(dCent >=40. && dCent < 60.) {hEvent5->Fill(dCent);}//All Event Number
      if(dCent >=60. && dCent < 80.) {hEvent6->Fill(dCent);}//All Event Number
      if(dCent >=80. && dCent < 100.) {hEvent7->Fill(dCent);}//All Event Number
    
    Int_t nV0s = 0;
    if((sOpt == "Kshort") || (sOpt == "Lambda") || (sOpt == "AntiLa")){
      nV0s = fV0sClArr->GetEntriesFast(); if (nV0s<=0) continue;
      
      if(dCent >= 0. && dCent< 100.){ hStrEvent->Fill(dCent);}
      if(dCent >= 0. && dCent< 90.){ hStrEvent0->Fill(dCent);}
      if(dCent >=0. && dCent< 5.)  {hStrEvent1->Fill(dCent);}
      if(dCent >=5. && dCent< 10.)  {hStrEvent2->Fill(dCent);}
      if(dCent >=10. && dCent< 20.)  {hStrEvent3->Fill(dCent);}
      if(dCent >=20. && dCent< 40.)  {hStrEvent4->Fill(dCent);}
      if(dCent >=40. && dCent< 60.)  {hStrEvent5->Fill(dCent);}
      if(dCent >=60. && dCent< 80.)  {hStrEvent6->Fill(dCent);}
      if(dCent >=80. && dCent< 100.)  {hStrEvent7->Fill(dCent);}
	...
	if(dCent>=0. && dCent< 90.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM0); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM0); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM0); }
	} 
	if(dCent>=0. && dCent< 5.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM1); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM1); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM1); }
	} 
	if(dCent>=5. && dCent< 10.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM2); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM2); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM2); }
	} 
	if(dCent>=10. && dCent< 20.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM3); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM3); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM3); }
	} 
	if(dCent>=20. && dCent< 40.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM4); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM4); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM4); }
	} 
	if(dCent>=40. && dCent< 60.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM5); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM5); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM5); }
	} 
	if(dCent>=60. && dCent< 80.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM6); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM6); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM6); }
	} 
	if(dCent>=80. && dCent< 100.){
          if (bKshort) { if (pV0->IsKshort(fKaCuts)) pV0->FillKshortPtInvM(hPtInvM7); }
          if (bLambda) { if (pV0->IsLambda(fLaCuts)) pV0->FillLambdaPtInvM(hPtInvM7); }
          if (bAntiLa) { if (pV0->IsAntiLa(fLaCuts)) pV0->FillAntiLaPtInvM(hPtInvM7); }
	} 
	pV0 = 0;
      }
    }
...
//=============================================================================
	...
	if( dCent>=0. && dCent< 90.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM0);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM0);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM0);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM0);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM0);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM0);}
	}
	if( dCent>=0. && dCent< 5.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM1);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM1);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM1);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM1);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM1);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM1);}
	}
	if( dCent>=5. && dCent< 10.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM2);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM2);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM2);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM2);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM2);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM2);}
	}
	if( dCent>=10. && dCent< 20.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM3);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM3);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM3);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM3);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM3);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM3);}
	}
	if( dCent>=20. && dCent< 40.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM4);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM4);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM4);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM4);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM4);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM4);}
	}
	if( dCent>=40. && dCent< 60.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM5);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM5);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM5);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM5);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM5);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM5);}
	}
	if( dCent>=60. && dCent< 80.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM6);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM6);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM6);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM6);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM6);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM6);}
	}
	if( dCent>=80. && dCent< 100.){
          if (bXiNeg) pCascade->FillXiNegPtInvM(hPtInvM7);
          if (bXiPos) pCascade->FillXiPosPtInvM(hPtInvM7);
          if (bXi) {pCascade->FillXiPtInvM(hPtInvM7);}
          if (bOmegaNeg) pCascade->FillOmegaNegPtInvM(hPtInvM7);
          if (bOmegaPos) pCascade->FillOmegaPosPtInvM(hPtInvM7);
          if (bOmega) {pCascade->FillOmegaPtInvM(hPtInvM7);}
	}
        pCascade = 0;
...
//=============================================================================
  ...
  file->cd(); list->Write(Form("%s_0100",fListLoop1st.Data()), TObject::kSingleKey); 
  file->cd(); list0->Write(Form("%s_090",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list1->Write(Form("%s_05",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list2->Write(Form("%s_510",fListLoop1st.Data()), TObject::kSingleKey); 
  file->cd(); list3->Write(Form("%s_1020",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list4->Write(Form("%s_2040",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list5->Write(Form("%s_4060",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list6->Write(Form("%s_6080",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list7->Write(Form("%s_80100",fListLoop1st.Data()), TObject::kSingleKey);
  file->Close();
  return;
}
...
//=============================================================================
  ...
  TList *list = (TList*)file->Get(Form("%s_0100",fListFitInvM.Data())); if (!list) return;
  TH1D *hFitPtInvM = (TH1D*)list->FindObject("hFitPtInvM"); if (!hFitPtInvM) return;
  
  TList *list0 = (TList*)file->Get(Form("%s_090",fListFitInvM.Data())); if (!list0) return;
  TH1D *hFitPtInvM0 = (TH1D*)list0->FindObject("hFitPtInvM"); if (!hFitPtInvM0) return;

  TList *list1 = (TList*)file->Get(Form("%s_05",fListFitInvM.Data())); if (!list1) return;
  TH1D *hFitPtInvM1 = (TH1D*)list1->FindObject("hFitPtInvM"); if (!hFitPtInvM1) return;
  
  TList *list2 = (TList*)file->Get(Form("%s_510",fListFitInvM.Data())); if (!list2) return;
  TH1D *hFitPtInvM2 = (TH1D*)list2->FindObject("hFitPtInvM"); if (!hFitPtInvM2) return;

  TList *list3 = (TList*)file->Get(Form("%s_1020",fListFitInvM.Data())); if (!list3) return;
  TH1D *hFitPtInvM3 = (TH1D*)list3->FindObject("hFitPtInvM"); if (!hFitPtInvM3) return;
  
  TList *list4 = (TList*)file->Get(Form("%s_2040",fListFitInvM.Data())); if (!list4) return;
  TH1D *hFitPtInvM4 = (TH1D*)list4->FindObject("hFitPtInvM"); if (!hFitPtInvM4) return;
  
  TList *list5 = (TList*)file->Get(Form("%s_4060",fListFitInvM.Data())); if (!list5) return;
  TH1D *hFitPtInvM5 = (TH1D*)list5->FindObject("hFitPtInvM"); if (!hFitPtInvM5) return;
 
  TList *list6 = (TList*)file->Get(Form("%s_6080",fListFitInvM.Data())); if (!list6) return;
  TH1D *hFitPtInvM6 = (TH1D*)list6->FindObject("hFitPtInvM"); if (!hFitPtInvM6) return;

  TList *list7 = (TList*)file->Get(Form("%s_80100",fListFitInvM.Data())); file->Close(); if (!list7) return;
  TH1D *hFitPtInvM7 = (TH1D*)list7->FindObject("hFitPtInvM"); if (!hFitPtInvM7) return;
//=============================================================================

  file = TFile::Open(Form("%s.root",fFileLoop2nd.Data()), "UPDATE");
  list = (TList*)file->Get(Form("%s_0100",fListLoop2nd.Data())); if (list) { file->Close(); return; } else { list = new TList(); }
  ...
  TH1D *hStrEvent = new TH1D("hStrEvent", "", 100, 0., 100.); hStrEvent->Sumw2(); list->Add(hStrEvent);
//=============================================================================
  list0 = (TList*)file->Get(Form("%s_090",fListLoop2nd.Data())); if (list0) { file->Close(); return; } else { list0 = new TList(); }
  TH2D *hPtEtaI0 = (TH2D*)hPtEtaI->Clone(); list0->Add(hPtEtaI0);
  TH1D *hCountInW0 = (TH1D*)hCountInW->Clone(); list0->Add(hCountInW0);
  TH1D *hCountInB0 = (TH1D*)hCountInB->Clone(); list0->Add(hCountInB0);
  TH1D *hEvent0 = (TH1D*)hEvent->Clone(); list0->Add(hEvent0);
  TH1D *hStrEvent0 = (TH1D*)hStrEvent->Clone(); list0->Add(hStrEvent0);

//=============================================================================
  list1 = (TList*)file->Get(Form("%s_05",fListLoop2nd.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
  TH2D *hPtEtaI1 = (TH2D*)hPtEtaI->Clone(); list1->Add(hPtEtaI1);
  TH1D *hCountInW1 = (TH1D*)hCountInW->Clone(); list1->Add(hCountInW1);
  TH1D *hCountInB1 = (TH1D*)hCountInB->Clone(); list1->Add(hCountInB1);
  TH1D *hEvent1 = (TH1D*)hEvent->Clone(); list1->Add(hEvent1);
  TH1D *hStrEvent1 = (TH1D*)hStrEvent->Clone(); list1->Add(hStrEvent1);

//=============================================================================
  list2 = (TList*)file->Get(Form("%s_510",fListLoop2nd.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
  TH2D *hPtEtaI2 = (TH2D*)hPtEtaI->Clone(); list2->Add(hPtEtaI2);
  TH1D *hCountInW2 = (TH1D*)hCountInW->Clone(); list2->Add(hCountInW2);
  TH1D *hCountInB2 = (TH1D*)hCountInB->Clone(); list2->Add(hCountInB2);
  TH1D *hEvent2 = (TH1D*)hEvent->Clone(); list2->Add(hEvent2);
  TH1D *hStrEvent2 = (TH1D*)hStrEvent->Clone(); list2->Add(hStrEvent2);

//=============================================================================
  list3 = (TList*)file->Get(Form("%s_1020",fListLoop2nd.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
  TH2D *hPtEtaI3 = (TH2D*)hPtEtaI->Clone(); list3->Add(hPtEtaI3);
  TH1D *hCountInW3 = (TH1D*)hCountInW->Clone(); list3->Add(hCountInW3);
  TH1D *hCountInB3 = (TH1D*)hCountInB->Clone(); list3->Add(hCountInB3);
  TH1D *hEvent3 = (TH1D*)hEvent->Clone(); list3->Add(hEvent3);
  TH1D *hStrEvent3 = (TH1D*)hStrEvent->Clone(); list3->Add(hStrEvent3);

//=============================================================================
  list4 = (TList*)file->Get(Form("%s_2040",fListLoop2nd.Data())); if (list4) { file->Close(); return; } else { list4 = new TList(); }
  TH2D *hPtEtaI4 = (TH2D*)hPtEtaI->Clone(); list4->Add(hPtEtaI4);
  TH1D *hCountInW4 = (TH1D*)hCountInW->Clone(); list4->Add(hCountInW4);
  TH1D *hCountInB4 = (TH1D*)hCountInB->Clone(); list4->Add(hCountInB4);
  TH1D *hEvent4 = (TH1D*)hEvent->Clone(); list4->Add(hEvent4);
  TH1D *hStrEvent4 = (TH1D*)hStrEvent->Clone(); list4->Add(hStrEvent4);
//=============================================================================
  list5 = (TList*)file->Get(Form("%s_4060",fListLoop2nd.Data())); if (list5) { file->Close(); return; } else { list5 = new TList(); }
  TH2D *hPtEtaI5 = (TH2D*)hPtEtaI->Clone(); list5->Add(hPtEtaI5);
  TH1D *hCountInW5 = (TH1D*)hCountInW->Clone(); list5->Add(hCountInW5);
  TH1D *hCountInB5 = (TH1D*)hCountInB->Clone(); list5->Add(hCountInB5);
  TH1D *hEvent5 = (TH1D*)hEvent->Clone(); list5->Add(hEvent5);
  TH1D *hStrEvent5 = (TH1D*)hStrEvent->Clone(); list5->Add(hStrEvent5);
//=============================================================================
  list6 = (TList*)file->Get(Form("%s_6080",fListLoop2nd.Data())); if (list6) { file->Close(); return; } else { list6 = new TList(); }
  TH2D *hPtEtaI6 = (TH2D*)hPtEtaI->Clone(); list6->Add(hPtEtaI6);
  TH1D *hCountInW6 = (TH1D*)hCountInW->Clone(); list6->Add(hCountInW6);
  TH1D *hCountInB6 = (TH1D*)hCountInB->Clone(); list6->Add(hCountInB6);
  TH1D *hEvent6 = (TH1D*)hEvent->Clone(); list6->Add(hEvent6);
  TH1D *hStrEvent6 = (TH1D*)hStrEvent->Clone(); list6->Add(hStrEvent6);
//=============================================================================
  list7 = (TList*)file->Get(Form("%s_80100",fListLoop2nd.Data())); if (list7) { file->Close(); return; } else { list7 = new TList(); }
  TH2D *hPtEtaI7 = (TH2D*)hPtEtaI->Clone(); list7->Add(hPtEtaI7);
  TH1D *hCountInW7 = (TH1D*)hCountInW->Clone(); list7->Add(hCountInW7);
  TH1D *hCountInB7 = (TH1D*)hCountInB->Clone(); list7->Add(hCountInB7);
  TH1D *hEvent7 = (TH1D*)hEvent->Clone(); list7->Add(hEvent7);
  TH1D *hStrEvent7 = (TH1D*)hStrEvent->Clone(); list7->Add(hStrEvent7);
//=============================================================================
  ...
  while (fChainRD->GetEntry(iEvent++)) if (InitEvent("P")) {
	...
	if( dCent>=0. && dCent< 90.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW0->Fill(dPt); hPtEtaI0->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB0->Fill(dPt);
	}
	if( dCent>=0. && dCent< 5.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW1->Fill(dPt); hPtEtaI1->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB1->Fill(dPt);
	}
	if( dCent>=5. && dCent< 10.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW2->Fill(dPt); hPtEtaI2->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB2->Fill(dPt);
	}
	if( dCent>=10. && dCent< 20.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW3->Fill(dPt); hPtEtaI3->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB3->Fill(dPt);
	}
	if( dCent>=20. && dCent< 40.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW4->Fill(dPt); hPtEtaI4->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB4->Fill(dPt);
	}
	if( dCent>=40. && dCent< 60.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW5->Fill(dPt); hPtEtaI5->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB5->Fill(dPt);
	}
	if( dCent>=60. && dCent< 80.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW6->Fill(dPt); hPtEtaI6->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB6->Fill(dPt);
	}
	if( dCent>=80. && dCent< 100.){
          if  ((dInvM>dUpperL) && (dInvM<dLowerR))  { hCountInW7->Fill(dPt); hPtEtaI7->Fill(dPt, dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))   hCountInB7->Fill(dPt);
	}
        pV0 = 0;
      }
    }
...
//=============================================================================
  ...
  file->cd(); list->Write(Form("%s_0100",fListLoop2nd.Data()), TObject::kSingleKey); 
  list0->Write(Form("%s_090",fListLoop2nd.Data()), TObject::kSingleKey);
  list1->Write(Form("%s_05",fListLoop2nd.Data()), TObject::kSingleKey); 
  list2->Write(Form("%s_510",fListLoop2nd.Data()), TObject::kSingleKey); 
  list3->Write(Form("%s_1020",fListLoop2nd.Data()), TObject::kSingleKey);
  list4->Write(Form("%s_2040",fListLoop2nd.Data()), TObject::kSingleKey);
  list5->Write(Form("%s_4060",fListLoop2nd.Data()), TObject::kSingleKey);
  list6->Write(Form("%s_6080",fListLoop2nd.Data()), TObject::kSingleKey);
  list7->Write(Form("%s_80100",fListLoop2nd.Data()), TObject::kSingleKey);
  file->Close();
  return;
}
...
//=============================================================================
  ...
  TList *list1 = (TList*)file->Get(Form("%s_010",fListFitInvM.Data())); if (!list1) return;
  TH1D *hFitPtInvM1 = (TH1D*)list1->FindObject("hFitPtInvM"); if (!hFitPtInvM1) return;
  
  TList *list2 = (TList*)file->Get(Form("%s_1040",fListFitInvM.Data())); if (!list2) return;
  TH1D *hFitPtInvM2 = (TH1D*)list2->FindObject("hFitPtInvM"); if (!hFitPtInvM2) return;

  TList *list3 = (TList*)file->Get(Form("%s_4090",fListFitInvM.Data())); if (!list3) return;
  TH1D *hFitPtInvM3 = (TH1D*)list3->FindObject("hFitPtInvM"); if (!hFitPtInvM3) return;

  TList *list4 = (TList*)file->Get(Form("%s_40100",fListFitInvM.Data())); file->Close(); if (!list4) return;
  TH1D *hFitPtInvM4 = (TH1D*)list4->FindObject("hFitPtInvM"); if (!hFitPtInvM4) return;
//=============================================================================

  file =  TFile::Open(Form("%s.root",fFileLoop2nd.Data()), "READ"); if (!file->IsOpen()) return;
  list = (TList*)file->Get(Form("%s_0100",fListLoop2nd.Data())); if (!list) return;
  TH2D *hPtEtaI = (TH2D*)list->FindObject("hPtEtaI"); if (!hPtEtaI) return;

  list0 = (TList*)file->Get(Form("%s_090",fListLoop2nd.Data())); if (!list0) return;
  TH2D *hPtEtaI0 = (TH2D*)list0->FindObject("hPtEtaI"); if (!hPtEtaI0) return;
  
  list1 = (TList*)file->Get(Form("%s_010",fListLoop2nd.Data())); if (!list1) return;
  TH2D *hPtEtaI1 = (TH2D*)list1->FindObject("hPtEtaI"); if (!hPtEtaI1) return;

  list2 = (TList*)file->Get(Form("%s_1040",fListLoop2nd.Data())); if (!list2) return;
  TH2D *hPtEtaI2 = (TH2D*)list2->FindObject("hPtEtaI"); if (!hPtEtaI2) return;

  list3 = (TList*)file->Get(Form("%s_4090",fListLoop2nd.Data())); if (!list3) return;
  TH2D *hPtEtaI3 = (TH2D*)list3->FindObject("hPtEtaI"); if (!hPtEtaI3) return;

  list4 = (TList*)file->Get(Form("%s_40100",fListLoop2nd.Data())); file->Close(); if (!list4) return;
  TH2D *hPtEtaI4 = (TH2D*)list4->FindObject("hPtEtaI"); if (!hPtEtaI4) return;
 //=============================================================================
  
  file = TFile::Open(Form("%s.root",fFileLoopJet.Data()), "UPDATE");
  list = (TList*)file->Get(Form("%s_0100",fListLoopJet.Data())); if (list) { file->Close(); return; } else { list = new TList(); }
...
//=============================================================================
  list0 = (TList*)file->Get(Form("%s_090",fListLoopJet.Data())); if (list0) { file->Close(); return; } else { list0 = new TList(); }
  TH2D *hPtInvM0 = (TH2D*)hPtInvM->Clone(); list0->Add(hPtInvM0);
  TH2D *hPtEtaJ0 = (TH2D*)hPtEtaJ->Clone(); list0->Add(hPtEtaJ0);
  list0->Add(hPtEtaI0);
  TH1D *hCountInW0 = (TH1D*)hCountInW->Clone(); list0->Add(hCountInW0);
  TH1D *hCountInB0 = (TH1D*)hCountInB->Clone(); list0->Add(hCountInB0);
  TH1D *hEvent0 = (TH1D*)hEvent->Clone(); list0->Add(hEvent0);
  //TProfile *hProfAcc0 = (TProfile*)hProfAcc0->Clone(); list0->Add(hProfAcc0);
//=============================================================================
  list1 = (TList*)file->Get(Form("%s_010",fListLoopJet.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
  TH2D *hPtInvM1 = (TH2D*)hPtInvM->Clone(); list1->Add(hPtInvM1);
  TH2D *hPtEtaJ1 = (TH2D*)hPtEtaJ->Clone(); list1->Add(hPtEtaJ1);
  list1->Add(hPtEtaI1);
  TH1D *hCountInW1 = (TH1D*)hCountInW->Clone(); list1->Add(hCountInW1);
  TH1D *hCountInB1 = (TH1D*)hCountInB->Clone(); list1->Add(hCountInB1);
  TH1D *hEvent1 = (TH1D*)hEvent->Clone(); list1->Add(hEvent1);
  //TProfile *hProfAcc1 = (TProfile*)hProfAcc1->Clone(); list1->Add(hProfAcc1);
//=============================================================================
  list2 = (TList*)file->Get(Form("%s_1040",fListLoopJet.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
  TH2D *hPtInvM2 = (TH2D*)hPtInvM->Clone(); list2->Add(hPtInvM2);
  TH2D *hPtEtaJ2 = (TH2D*)hPtEtaJ->Clone(); list2->Add(hPtEtaJ2);
  list2->Add(hPtEtaI2);
  TH1D *hCountInW2 = (TH1D*)hCountInW->Clone(); list2->Add(hCountInW2);
  TH1D *hCountInB2 = (TH1D*)hCountInB->Clone(); list2->Add(hCountInB2);
  TH1D *hEvent2 = (TH1D*)hEvent->Clone(); list2->Add(hEvent2);
  //TProfile *hProfAcc2 = (TProfile*)hProfAcc2->Clone(); list2->Add(hProfAcc2);
//=============================================================================
  list3 = (TList*)file->Get(Form("%s_4090",fListLoopJet.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
  TH2D *hPtInvM3 = (TH2D*)hPtInvM->Clone(); list3->Add(hPtInvM3);
  TH2D *hPtEtaJ3 = (TH2D*)hPtEtaJ->Clone(); list3->Add(hPtEtaJ3);
  list3->Add(hPtEtaI3);
  TH1D *hCountInW3 = (TH1D*)hCountInW->Clone(); list3->Add(hCountInW3);
  TH1D *hCountInB3 = (TH1D*)hCountInB->Clone(); list3->Add(hCountInB3);
  TH1D *hEvent3 = (TH1D*)hEvent->Clone(); list3->Add(hEvent3);
  //TProfile *hProfAcc3 = (TProfile*)hProfAcc3->Clone(); list3->Add(hProfAcc3);
//=============================================================================
  list4 = (TList*)file->Get(Form("%s_40100",fListLoopJet.Data())); if (list4) { file->Close(); return; } else { list4 = new TList(); }
  TH2D *hPtInvM4 = (TH2D*)hPtInvM->Clone(); list4->Add(hPtInvM4);
  TH2D *hPtEtaJ4 = (TH2D*)hPtEtaJ->Clone(); list4->Add(hPtEtaJ4);
  list4->Add(hPtEtaI4);
  TH1D *hCountInW4 = (TH1D*)hCountInW->Clone(); list4->Add(hCountInW4);
  TH1D *hCountInB4 = (TH1D*)hCountInB->Clone(); list4->Add(hCountInB4);
  TH1D *hEvent4 = (TH1D*)hEvent->Clone(); list4->Add(hEvent4);
  //TProfile *hProfAcc4 = (TProfile*)hProfAcc4->Clone(); list4->Add(hProfAcc4);
//=============================================================================
  ...
  while (fChainRD->GetEntry(iEvent++)) if (InitEvent("PJ")) {
    ...
    if(dCent >= 0. && dCent< 100.){ hEvent->Fill(dCent);}//All Event Number
    if(dCent >=0. && dCent< 90.) {hEvent0->Fill(dCent);}//All Event Number
    if(dCent >=0. && dCent< 10.) {hEvent1->Fill(dCent);}//All Event Number
    if(dCent >=10. && dCent< 40.) {hEvent2->Fill(dCent);}//All Event Number
    if(dCent >=40. && dCent< 90.) {hEvent3->Fill(dCent);}//All Event Number
    if(dCent >=40. && dCent< 100.) {hEvent4->Fill(dCent);}//All Event Number
...
//===============================================================================
        ...
        if( dCent>=0. && dCent< 90.){
          if (bKshort) pV0->FillKshortPtInvM(hPtInvM0);
          if (bLambda) pV0->FillLambdaPtInvM(hPtInvM0);
          if (bAntiLa) pV0->FillAntiLaPtInvM(hPtInvM0);
          if  ((dInvM>dUpperL) && (dInvM<dLowerR)) { hCountInW0->Fill(dPt); hPtEtaJ0->Fill(dPt,dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))  hCountInB0->Fill(dPt);
	}
        if( dCent>=0. && dCent< 10.){
          if (bKshort) pV0->FillKshortPtInvM(hPtInvM1);
          if (bLambda) pV0->FillLambdaPtInvM(hPtInvM1);
          if (bAntiLa) pV0->FillAntiLaPtInvM(hPtInvM1);
          if  ((dInvM>dUpperL) && (dInvM<dLowerR)) { hCountInW1->Fill(dPt); hPtEtaJ1->Fill(dPt,dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))  hCountInB1->Fill(dPt);
	}
        if( dCent>=10. && dCent< 40.){
          if (bKshort) pV0->FillKshortPtInvM(hPtInvM2);
          if (bLambda) pV0->FillLambdaPtInvM(hPtInvM2);
          if (bAntiLa) pV0->FillAntiLaPtInvM(hPtInvM2);
          if  ((dInvM>dUpperL) && (dInvM<dLowerR)) { hCountInW2->Fill(dPt); hPtEtaJ2->Fill(dPt,dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))  hCountInB2->Fill(dPt);
	}
        if( dCent>=40. && dCent< 90.){
          if (bKshort) pV0->FillKshortPtInvM(hPtInvM3);
          if (bLambda) pV0->FillLambdaPtInvM(hPtInvM3);
          if (bAntiLa) pV0->FillAntiLaPtInvM(hPtInvM3);
          if  ((dInvM>dUpperL) && (dInvM<dLowerR)) { hCountInW3->Fill(dPt); hPtEtaJ3->Fill(dPt,dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))  hCountInB3->Fill(dPt);
	}
        if( dCent>=40. && dCent< 100.){
          if (bKshort) pV0->FillKshortPtInvM(hPtInvM4);
          if (bLambda) pV0->FillLambdaPtInvM(hPtInvM4);
          if (bAntiLa) pV0->FillAntiLaPtInvM(hPtInvM4);
          if  ((dInvM>dUpperL) && (dInvM<dLowerR)) { hCountInW4->Fill(dPt); hPtEtaJ4->Fill(dPt,dEta); }
          if (((dInvM>dLowerL) && (dInvM<dUpperL)) || ((dInvM>dLowerR) && (dInvM<dUpperR)))  hCountInB4->Fill(dPt);
	}
...
//=============================================================================
 ...
 //=============================================================================
   ...
   hProfAcc->Fill(0., dAll); hProfAcc->Fill(1., dOut); hProfAcc->Fill(2., dInC);
   //if( dCent>=0. && dCent< 10.){ hProfAcc1->Fill(0., dAll); hProfAcc1->Fill(1., dOut); hProfAcc1->Fill(2., dInC);}
   //if( dCent>=10. && dCent< 40.){ hProfAcc2->Fill(0., dAll); hProfAcc2->Fill(1., dOut); hProfAcc2->Fill(2., dInC);}
   //if( dCent>=40. && dCent< 90.){ hProfAcc3->Fill(0., dAll); hProfAcc3->Fill(1., dOut); hProfAcc3->Fill(2., dInC);}
...
//=============================================================================
  ...
  file->cd(); list->Write(Form("%s_0100",fListLoopJet.Data()), TObject::kSingleKey); 
  list0->Write(Form("%s_090",fListLoopJet.Data()), TObject::kSingleKey);
  list1->Write(Form("%s_010",fListLoopJet.Data()), TObject::kSingleKey); 
  list2->Write(Form("%s_1040",fListLoopJet.Data()), TObject::kSingleKey); 
  list3->Write(Form("%s_4090",fListLoopJet.Data()), TObject::kSingleKey);
  list4->Write(Form("%s_40100",fListLoopJet.Data()), TObject::kSingleKey);
  file->Close();
  return;
}
...
//=============================================================================
    ...
    if(dCent >=0. && dCent< 10.) {hEvent1->Fill(dCent);}//All Event Number
    if(dCent >=10. && dCent< 40.) {hEvent2->Fill(dCent);}//All Event Number
    if(dCent >=40. && dCent< 90.) {hEvent2->Fill(dCent);}//All Event Number
...
//=============================================================================
  ...
  list2->Write(Form("%s_1040",fListLoopJet.Data()), TObject::kSingleKey); 
  list3->Write(Form("%s_4090",fListLoopJet.Data()), TObject::kSingleKey);
  list4->Write(Form("%s_4090",fListLoopJet.Data()), TObject::kSingleKey);
  file->Close();
  return;
}
...
void AliAnalysisTaskUserStraneJets::SetDefaultXiCutsPP()
{
  Double_t dCuts[] = {1.4,   // [ 0] V0 MinRadius,
                      ...
                      -1.,   // [13] Xi MaxXiDCAtoPV,
                      0.07,  // [14] Xi MinV0DCAtoPV,
                      1.6,   // [15] Xi MaxV0toBachDCA,
                      0.05,  // [16] Xi MinBachDCAtoPV,
                      70.,   // [17] Xi MinBachXrowsTPC,
                      0.8,   // [18] Xi MinBachXrowsOverFindableClusTPC,
                      0.008  // [19] Xi Compete Mass
                     };

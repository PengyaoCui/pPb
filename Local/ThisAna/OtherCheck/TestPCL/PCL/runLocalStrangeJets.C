...
void runLocalStrangeJets()
{
  ...
  const TString sCent[] = {"0100", "5100", "510", "110", "1100", "40100"};
  ...
  if(!IsMC){
    ...
    for(Int_t p = 0; p < sizeof(tType)/sizeof(TString); p++)
    {
      ...
      ana->SetDataFitInvM(sFileFitInvMrd, Form("%s_%s_%s_1100",sListFitInvMrd.Data(),sType1.Data(),sCut.Data()));
      ana->SetDataLoopsMC(sFileLoopIncMC, Form("%s_%s_%s_1100",slistLoopIncMC.Data(),sType1.Data(),sCut.Data())); ana->AnaLoopsMC(sType1.Data());
      ana->SetDataLoop1st(sFileLoopIncMC, Form("%s_%s_%s_1100",slistLoopIncMC.Data(),sType1.Data(),sCut.Data()));
      ana->SetDataLoop2nd(sFileLoopIncMC, Form("%s_%s_%s_1100",slistLoopIncMC.Data(),sType1.Data(),sCut.Data()));
      ana->SetDataFitCbin(sFileFitCbinMC, Form("%s_%s_%s_1100",slistFitCbinMC.Data(),sType1.Data(),sCut.Data()));  ana->AnaFitCbin(sType1.Data());
      ana->SetDataMakeEff(sFileEffInclMC, Form("%s_%s_%s_1100",slistEffInclMC.Data(),sType1.Data(),sCut.Data()));  ana->AnaInclEff(sType1.Data(), hPt);
      if(IsJet){
        hPtEta =(TH2D*)f1->Get(Form("%s_pT_Eta", sType1.Data()));
        ana->SetDataLoop2nd(sFileLoopJetRD, Form("%s_%s_%s_1100",sListLoopJetRD.Data(),sType1.Data(),sFix.Data()));
        ana->SetDataMakeEff(sFileEffCorrMC, Form("%s_%s_%s_1100",slistEffCorrMC.Data(),sType1.Data(),sCut.Data()));  ana->AnaCorrEff(hPtEta, "I");
        ana->SetDataMakeEff(sFileEffCorrJE, Form("%s_%s_%s_1100",slistEffCorrJE.Data(),sType1.Data(),sFix.Data()));  ana->AnaCorrEff(hPtEta, "J");
      }
    }
  }
  ...
  if(IsAnaResults){
    ...
    for(Int_t p = 0; p < sizeof(tType)/sizeof(TString); p++){
      ...
      for(Int_t c = 0; c < sizeof(sCent)/sizeof(TString); c++)
      {
        ...
        ana->SetDataFitCbin(sFileFitCbinRD, Form("%s_%s_%s_%s",slistFitCbinRD.Data(),sType1.Data(),sCut.Data(), Cent.Data()));
        if(IsJet){
          ana->SetDataMakeEff(sFileEffCorrMC, Form("%s_%s_%s_1100",slistEffCorrMC.Data(),sType1.Data(),sCut.Data()));
        }else{
          ana->SetDataMakeEff(sFileEffInclMC, Form("%s_%s_%s_1100",slistEffInclMC.Data(),sType1.Data(),sCut.Data()));
        }
        ...
        if(IsJet){
          ana->SetDataLoop1st(sFileLoopJetRD, Form("%s_%s_%s_%s",sListLoopJetRD.Data(),sType1.Data(),sFix.Data(), Cent.Data()));
          ana->SetDataFitCbin(sFileFitCbinJE, Form("%s_%s_%s_%s",slistFitCbinJE.Data(),sType1.Data(),sFix.Data(), Cent.Data()));
          ana->SetDataMakeEff(sFileEffCorrJE, Form("%s_%s_%s_1100",slistEffCorrJE.Data(),sType1.Data(),sFix.Data()));

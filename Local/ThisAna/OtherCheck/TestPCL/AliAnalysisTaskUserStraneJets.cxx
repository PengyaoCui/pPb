...
//=============================================================================
  TList *list0 = (TList*)file->Get(Form("%s_5100",fListLoop1st.Data())); if (list0) { file->Close(); return; } else { list0 = new TList(); }
  TH2D *hPtInvM0 = 0;
...
//=============================================================================
  TList *list1 = (TList*)file->Get(Form("%s_510",fListLoop1st.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
  TH2D *hPtInvM1 = 0;
...
//=============================================================================
  TList *list2 = (TList*)file->Get(Form("%s_110",fListLoop1st.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
  TH2D *hPtInvM2 = 0;
...
//=============================================================================
  TList *list3 = (TList*)file->Get(Form("%s_1100",fListLoop1st.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
  TH2D *hPtInvM3 = 0;
  ...
  while (fChainRD->GetEntry(iEvent++)) if (InitEvent("P")) {
   ...
   if(iEvent%1000000==0) cout<<iEvent/1000000<< " = M"<<endl; 
    Float_t dCent = -1.;
      ...
      if(dCent >=5. && dCent< 100.) {hEvent0->Fill(dCent);}//All Event Number
      if(dCent >=5. && dCent< 10.) {hEvent1->Fill(dCent);}//All Event Number
      if(dCent >=1. && dCent< 10.) {hEvent2->Fill(dCent);}//All Event Number
      if(dCent >=1. && dCent < 100.) {hEvent3->Fill(dCent);}//All Event Number
    ...
    if((sOpt == "Kshort") || (sOpt == "Lambda") || (sOpt == "AntiLa")){
      ...
      if(dCent >= 5. && dCent< 100.){ hStrEvent0->Fill(dCent);}
      if(dCent >=5. && dCent< 10.)  {hStrEvent1->Fill(dCent);}
      if(dCent >=1. && dCent< 10.)  {hStrEvent2->Fill(dCent);}
      if(dCent >=1. && dCent< 100.)  {hStrEvent3->Fill(dCent);}
...
//=============================================================================
  ...
  file->cd(); list0->Write(Form("%s_5100",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list1->Write(Form("%s_510",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list2->Write(Form("%s_110",fListLoop1st.Data()), TObject::kSingleKey); 
  file->cd(); list3->Write(Form("%s_1100",fListLoop1st.Data()), TObject::kSingleKey);
...
//=============================================================================
  ...
  TList *list0 = (TList*)file->Get(Form("%s_5100",fListFitInvM.Data())); if (!list0) return;
  TH1D *hFitPtInvM0 = (TH1D*)list0->FindObject("hFitPtInvM"); if (!hFitPtInvM0) return;

  TList *list1 = (TList*)file->Get(Form("%s_510",fListFitInvM.Data())); if (!list1) return;
  TH1D *hFitPtInvM1 = (TH1D*)list1->FindObject("hFitPtInvM"); if (!hFitPtInvM1) return;
  
  TList *list2 = (TList*)file->Get(Form("%s_110",fListFitInvM.Data())); if (!list2) return;
  TH1D *hFitPtInvM2 = (TH1D*)list2->FindObject("hFitPtInvM"); if (!hFitPtInvM2) return;

  TList *list3 = (TList*)file->Get(Form("%s_1100",fListFitInvM.Data())); if (!list3) return;
...
//=============================================================================
  ...
  TH1D *hStrEvent = new TH1D("hStrEvent", "", 100, 0., 100.); hStrEvent->Sumw2(); list->Add(hStrEvent);
//=============================================================================
  list0 = (TList*)file->Get(Form("%s_5100",fListLoop2nd.Data())); if (list0) { file->Close(); return; } else { list0 = new TList(); }
...
//=============================================================================
  list1 = (TList*)file->Get(Form("%s_510",fListLoop2nd.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
...
//=============================================================================
  list2 = (TList*)file->Get(Form("%s_110",fListLoop2nd.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
...
//=============================================================================
  list3 = (TList*)file->Get(Form("%s_1100",fListLoop2nd.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
...
//=============================================================================
  ...
  list0->Write(Form("%s_5100",fListLoop2nd.Data()), TObject::kSingleKey);
  list1->Write(Form("%s_510",fListLoop2nd.Data()), TObject::kSingleKey); 
  list2->Write(Form("%s_110",fListLoop2nd.Data()), TObject::kSingleKey); 
  list3->Write(Form("%s_1100",fListLoop2nd.Data()), TObject::kSingleKey);
...
//=============================================================================
  ...
  list0 = (TList*)file->Get(Form("%s_5100",fListLoop2nd.Data())); if (!list0) return;
  TH2D *hPtEtaI0 = (TH2D*)list0->FindObject("hPtEtaI"); if (!hPtEtaI0) return;
  
  list1 = (TList*)file->Get(Form("%s_510",fListLoop2nd.Data())); if (!list1) return;
  TH2D *hPtEtaI1 = (TH2D*)list1->FindObject("hPtEtaI"); if (!hPtEtaI1) return;

  list2 = (TList*)file->Get(Form("%s_110",fListLoop2nd.Data())); if (!list2) return;
  TH2D *hPtEtaI2 = (TH2D*)list2->FindObject("hPtEtaI"); if (!hPtEtaI2) return;

  list3 = (TList*)file->Get(Form("%s_1100",fListLoop2nd.Data())); if (!list3) return;
...
//=============================================================================
  list0 = (TList*)file->Get(Form("%s_5100",fListLoopJet.Data())); if (list0) { file->Close(); return; } else { list0 = new TList(); }
...
//=============================================================================
  list1 = (TList*)file->Get(Form("%s_510",fListLoopJet.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
...
//=============================================================================
  list2 = (TList*)file->Get(Form("%s_110",fListLoopJet.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
...
//=============================================================================
  list3 = (TList*)file->Get(Form("%s_1100",fListLoopJet.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
...
//=============================================================================
  ...
  list0->Write(Form("%s_5100",fListLoopJet.Data()), TObject::kSingleKey);
  list1->Write(Form("%s_510",fListLoopJet.Data()), TObject::kSingleKey); 
  list2->Write(Form("%s_110",fListLoopJet.Data()), TObject::kSingleKey); 
  list3->Write(Form("%s_1100",fListLoopJet.Data()), TObject::kSingleKey);
...
//=============================================================================
    ...
    if (fCentralityEstimator=="ZNA") dCent = fMult->GetMultiplicityPercentile("ZNA");
    if(dCent >= 0. && dCent< 100.){ hEvent->Fill(dCent);}//All Event Number
    if(dCent >= 5. && dCent< 100.){ hEvent->Fill(dCent);}//All Event Number
    if(dCent >=5. && dCent< 10.) {hEvent1->Fill(dCent);}//All Event Number
    if(dCent >=1. && dCent< 10.) {hEvent2->Fill(dCent);}//All Event Number
    if(dCent >=1. && dCent< 100.) {hEvent3->Fill(dCent);}//All Event Number
    if(dCent >=40. && dCent< 100.) {hEvent4->Fill(dCent);}//All Event Number

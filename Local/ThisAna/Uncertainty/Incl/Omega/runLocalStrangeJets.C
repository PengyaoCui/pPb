...
Bool_t Config(AliAnalysisTaskUserStraneJets *ana, Double_t dcMin, Double_t dcMax, TH2D *hRM=0)
{
  ...
  const Double_t dKaPtBin[] = { 0.9, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8, 3.2, 3.7, 4.2, 5.0, 6.0, 8.0, 12.};
  const Int_t nKaPtBin = sizeof(dKaPtBin)/sizeof(Double_t) - 1;

  const Double_t dLaPtBin[] = { 0.9, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8, 3.2, 3.7, 4.2, 5.0, 6.0, 8.0, 12.};
  const Int_t nLaPtBin = sizeof(dLaPtBin)/sizeof(Double_t) - 1;

  const Double_t dXiPtBin[] = { 0.9, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8, 3.2, 3.7, 4.2, 5.0, 6.0, 8.0};
  const Int_t nXiPtBin = sizeof(dXiPtBin)/sizeof(Double_t) - 1;

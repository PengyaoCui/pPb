...
void AliAnalysisTaskUserStraneJets::SetDefaultXiCutsPA()
{
  Double_t dCuts[] = {
                      ...
                      1000., // [ 2] V0 MaxCtau,
                      1.1,   // [ 3] V0 MaxDausDCA,
                      0.17,  // [ 4] V0 MinPosDCAtoPV,
                      0.17,  // [ 5] V0 MinNegDCAtoPV,
                      70.,   // [ 6] V0 MinDauXrowsTPC,
                      0.8,   // [ 7] V0 MinDauXrowsOverFindableClusTPC,
                      -1.,   // [ 8] V0 MinDauDeltaM
                      4.,    // [ 9] Trks(Pos, Nes, Bach) max SigmaTPC
                      0.006, // [10] V0 MaxWindMass,
                      1.1,   // [11] Xi MinXiRadius,
                      0.982,  // [12] Xi MinXiCosPA,
                      15., // [13] Xi MaxXiCtau,
                      -1.,   // [14] Xi MaxXiDCAtoPV,
                      0.17,  // [15] Xi MinV0DCAtoPV,
                      0.9,   // [16] Xi MaxV0toBachDCA,
                      0.22,  // [17] Xi MinBachDCAtoPV,

...
void Histo(){
  ...
  hPtKshort->SetName(Form("Kshort_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtLambda->SetName(Form("Lambda_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtAntiLa->SetName(Form("AntiLa_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtXi->SetName(Form("Xi_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtXiNeg->SetName(Form("XiNeg_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtXiPos->SetName(Form("XiPos_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtOmega->SetName(Form("Omega_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtOmegaNeg->SetName(Form("OmegaNeg_%d%d", int(dCentMin), int(dCentMax))); 
  ...
  hPtOmegaPos->SetName(Form("OmegaPos_%d%d", int(dCentMin), int(dCentMax))); 

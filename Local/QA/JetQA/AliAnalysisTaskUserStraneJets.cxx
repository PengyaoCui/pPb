...
//=============================================================================
  TList *list1 = (TList*)file->Get(Form("%s_010",fListLoop1st.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
  TH2D *hPtInvM1 = 0;
...
//=============================================================================
  TList *list2 = (TList*)file->Get(Form("%s_1040",fListLoop1st.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
  TH2D *hPtInvM2 = 0;
...
//=============================================================================
  TList *list3 = (TList*)file->Get(Form("%s_4090",fListLoop1st.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
  TH2D *hPtInvM3 = 0;
  ...
  //=============================================================================
  TList *list4 = (TList*)file->Get(Form("%s_40100",fListLoop1st.Data())); if (list4) { file->Close(); return; } else { list4 = new TList(); }
  TH2D *hPtInvM4 = 0;
  ...
  while (fChainRD->GetEntry(iEvent++)) if (InitEvent("P")) {
   ...
   if(iEvent%1000000==0) cout<<iEvent/1000000<< " = M"<<endl; 
    ...
    if((sOpt == "Kshort") || (sOpt == "Lambda") || (sOpt == "AntiLa")){
      ...
      if(dCent >=0. && dCent< 10.)  {hStrEvent1->Fill(dCent);}
      if(dCent >=10. && dCent< 40.)  {hStrEvent2->Fill(dCent);}
      if(dCent >=40. && dCent< 90.)  {hStrEvent3->Fill(dCent);}
      if(dCent >=40. && dCent< 100.)  {hStrEvent4->Fill(dCent);}
...
//=============================================================================
  ...
  file->cd(); list1->Write(Form("%s_010",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list2->Write(Form("%s_1040",fListLoop1st.Data()), TObject::kSingleKey); 
  file->cd(); list3->Write(Form("%s_4090",fListLoop1st.Data()), TObject::kSingleKey);
  file->cd(); list4->Write(Form("%s_40100",fListLoop1st.Data()), TObject::kSingleKey);
  file->Close();
  return;
}
...
//=============================================================================
  list1 = (TList*)file->Get(Form("%s_010",fListLoop2nd.Data())); if (list1) { file->Close(); return; } else { list1 = new TList(); }
...
//=============================================================================
  list2 = (TList*)file->Get(Form("%s_1040",fListLoop2nd.Data())); if (list2) { file->Close(); return; } else { list2 = new TList(); }
...
//=============================================================================
  list3 = (TList*)file->Get(Form("%s_4090",fListLoop2nd.Data())); if (list3) { file->Close(); return; } else { list3 = new TList(); }
...
//=============================================================================
  list4 = (TList*)file->Get(Form("%s_40100",fListLoop2nd.Data())); if (list4) { file->Close(); return; } else { list4 = new TList(); }
...
//=============================================================================
  ...
  list1->Write(Form("%s_010",fListLoop2nd.Data()), TObject::kSingleKey); 
  list2->Write(Form("%s_1040",fListLoop2nd.Data()), TObject::kSingleKey); 
  list3->Write(Form("%s_4090",fListLoop2nd.Data()), TObject::kSingleKey);
  list4->Write(Form("%s_40100",fListLoop2nd.Data()), TObject::kSingleKey);
  file->Close();
  return;
}
...
//=============================================================================
 ...
 //=============================================================================
  ...
  TH1D *hRhoArea       = new TH1D("hRhoArea", "", 100, -1., 19.);        hRhoArea->Sumw2();     list->Add(hRhoArea);
...
//=============================================================================
    for (Int_t j=0; j<nJets; j++) {
      ...
      hRhoArea->Fill(pJet->Area() * fHeader->BackgroundRho());
